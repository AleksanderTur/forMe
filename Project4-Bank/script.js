...
/// спочатку створюємо і перевіряємо функціональність на одному прикладі, і маленькими кроками, а потім переносим це на більшу "скалу"
...
const displayTotal = function (account) {
  ...
  labelSumIn.textContent = `${depositiesTotal}$`;
